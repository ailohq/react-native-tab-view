...
class TabBar extends React.Component {
  constructor(...args) {
    ...
    _defineProperty(this, "getComputedTabWidth", (index, layout, routes, scrollEnabled, tabWidths, flattenedWidth) => {
      if (flattenedWidth === 'auto') {
        return (tabWidths === null || tabWidths === void 0 ? void 0 : tabWidths[routes[index].key]) || 0;
      }
    ...
    _defineProperty(this, "scrollToTab", (index, animated = true) => {
  ...
  componentDidUpdate(prevProps, prevState) {
    ...
    if (prevProps.navigationState.routes.length !== navigationState.routes.length || prevProps.navigationState.index !== navigationState.index || prevState.layout.width !== layout.width || prevState.tabWidths !== tabWidths) {
      const isWidthDynamic = this.getFlattenedTabWidth(this.props.tabStyle) === 'auto';
      ...
      const animatedScroll = isWidthDynamic ? !!prevState.tabWidths && !!prevState.layout.width : !!prevState.layout.width;
